...
export const Content =() =>{ 
   return( <div>
        ...
        <section>
            <h3>UI</h3>
            <p>OpenText UFT One provides two views and ways to modify a test script: Keyword View and Expert View. These views enable UFT to act as an Integrated Development Environment (IDE) for the test, and UFT includes many standard IDE features, such as breakpoints to pause a test at predetermined places.</p>
        </section>
